...
功能: 获取离线命令词识别结果
*********************************************************/
bool SpeechProcess::Get_Offline_Recognise_Result(const std::shared_ptr<human_mic_msg::srv::GetOfflineResult::Request>& request,
							std::shared_ptr<human_mic_msg::srv::GetOfflineResult::Response>& response){
...
: rclcpp::Node(node_name){
	...
	get_offline_result_srv_ = this->create_service<human_mic_msg::srv::GetOfflineResult>(
		"get_offline_result_srv",[this](const std::shared_ptr<human_mic_msg::srv::GetOfflineResult::Request> request,
									std::shared_ptr<human_mic_msg::srv::GetOfflineResult::Response> response){
