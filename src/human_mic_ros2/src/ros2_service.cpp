/****************************************************************/
/* Copyright (c) 2023 Human Technology, Inc   				*/
...
功能: 初始化服务
*********************************************************/
void human_mic::setupMicArrayServices()
{
	get_device_srv_ = this->create_service<human_mic_msg::srv::GetDeviceType>(
		"get_device_info",[this](const std::shared_ptr<human_mic_msg::srv::GetDeviceType::Request> request,
                                std::shared_ptr<human_mic_msg::srv::GetDeviceType::Response> response){
		response->success = getDeviceTypeCallback(request,response);
		});
	set_awake_word_srv_ = this->create_service<human_mic_msg::srv::SetAwakeWord>(
		"set_awake_word",[this](const std::shared_ptr<human_mic_msg::srv::SetAwakeWord::Request> request,
	...
	switch_mic_srv_ = this->create_service<human_mic_msg::srv::SwitchMic>(
		"switch_mic_type",[this](const std::shared_ptr<human_mic_msg::srv::SwitchMic::Request> request,
...
功能: 获取设备版本信息
*********************************************************/
bool human_mic::getDeviceTypeCallback(const std::shared_ptr<human_mic_msg::srv::GetDeviceType::Request>& request,
                                std::shared_ptr<human_mic_msg::srv::GetDeviceType::Response>& response){
...
*********************************************************/
bool human_mic::setAwakeWordCallback(const std::shared_ptr<human_mic_msg::srv::SetAwakeWord::Request>& request,
	                           std::shared_ptr<human_mic_msg::srv::SetAwakeWord::Response>& response){
...
功能: 切换麦克风类型
*********************************************************/
bool human_mic::switchMicCallback(const std::shared_ptr<human_mic_msg::srv::SwitchMic::Request>& request,
								std::shared_ptr<human_mic_msg::srv::SwitchMic::Response>& response){
...
功能: 下发数据包
*********************************************************/
bool human_mic::Send_Serial_Data(ServicePacket &pkg)
{
	string section;
...
功能: 制作数据包
*********************************************************/
string human_mic::MakeMsgPacket(unsigned short sid, MsgType type, const string &content)
{
