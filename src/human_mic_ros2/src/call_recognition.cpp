...
功能: 服务结果处理回调函数
*********************************************************/
void Call::server_callback_(rclcpp::Client<human_mic_msg::srv::GetOfflineResult>::SharedFuture result)
{
...
int Call::request_()
{
	...
	auto request = std::make_shared<human_mic_msg::srv::GetOfflineResult::Request>();
	/***离线命令词识别服务参数设置***/
...
: rclcpp::Node(node_name,options){
	...
	/***离线命令词识别服务客服端创建***/
	Call_Client_ = this->create_client<human_mic_msg::srv::GetOfflineResult>(
