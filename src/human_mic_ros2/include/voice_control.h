...
#include "human_mic_msg/srv/get_offline_result.hpp"
using namespace std;
...
private:
	...
	rclcpp::Service<human_mic_msg::srv::GetOfflineResult>::SharedPtr get_offline_result_srv_;
	...
	bool Get_Offline_Recognise_Result(const std::shared_ptr<human_mic_msg::srv::GetOfflineResult::Request>& request,
