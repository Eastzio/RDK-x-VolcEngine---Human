...
public:
    ...
    int request_();
    void server_callback_(rclcpp::Client<human_mic_msg::srv::GetOfflineResult>::SharedFuture msg);
...
private:
    ...
    rclcpp::Client<human_mic_msg::srv::GetOfflineResult>::SharedPtr Call_Client_;
